...
CARDS = [
    ...
    ("31","上","three identical same-size balls stacked in a vertical column on a plain white background, the TOP ball bright red, the middle and bottom balls plain grey, soft natural shadows"),
    ("32","下","three identical same-size balls stacked in a vertical column on a plain white background, the BOTTOM ball bright red, the top and middle balls plain grey, soft natural shadows"),
